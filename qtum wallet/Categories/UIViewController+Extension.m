...
+ (UIViewController*) controllerInStoryboard:(NSString*) storyboard withIdentifire:(NSString*) identifire {
    ...
    if ([identifire isEqualToString:@"NewPayment"] || [identifire isEqualToString:@"WalletViewController"] || [identifire isEqualToString:@"BalancePageViewController"] || [identifire isEqualToString:@"TokenListViewController"]) {
