        ...
        for (NSDictionary* dict in addressBalance[@"balances"]) {
            ...
            if (balance) {
                if ([balance isKindOfClass:[NSNumber class]]) {
                    newAddressBalance[addressKey] = [[JKBigDecimal alloc] initWithString:[(NSNumber*)balance stringValue]];
                } else if ([balance isKindOfClass:[NSString class]]) {
                    newAddressBalance[addressKey] = [[JKBigDecimal alloc] initWithString:balance];
                }
            }
        }
