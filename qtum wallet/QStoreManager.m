...
- (NSArray <QStoreBuyRequest *> *)unfinishedRequests {
    
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"state != %i", QStoreBuyRequestStateIsPaid];
    return [self.buyRequests filteredArrayUsingPredicate:predicate];
}
