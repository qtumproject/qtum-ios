...
- (void)setUp {
	[super setUp];
	self.contractArgumentsInterpretator = [ContractArgumentsInterpretator new];
}

- (void)tearDown {
	[super tearDown];
	self.contractArgumentsInterpretator = nil;
}
...
- (void)testEncode_Uint256_String {
	...
	NSData *args = [self.contractArgumentsInterpretator contactArgumentsFromArrayOfValues:values andArrayOfTypes:types];
